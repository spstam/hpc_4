...
__global__ void render_clahe_kernel(const unsigned char* __restrict__ img_in, unsigned char* __restrict__ img_out, const int* __restrict__ all_luts, int w, int h, int grid_w, int grid_h);
#endif